  ...
  return (
    <div className="different-selection">
      ...
      <div className="individual-container">
        <div className="image-container">
          <img
            src="https://www.hdnicewallpapers.com/Walls/Big/Nature%20and%20Landscape/Beautiful_Nature_Background_Wallpapers.jpg"
            alt="big leaf"
          ></img>
        </div>
      ...
      <div className="individual-container">
        <div className="image-container">
          <img
            src="https://images.pexels.com/photos/38537/woodland-road-falling-leaf-natural-38537.jpeg?auto=compress&cs=tinysrgb&dpr=1&w=500"
            alt="big leaf"
          ></img>{" "}
        </div>
